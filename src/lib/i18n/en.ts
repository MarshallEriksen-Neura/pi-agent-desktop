...
export const en = {
  ...
  "settings.category.generalDetail": "Language, startup layout, notifications, updates, and window behavior.",
  "settings.interface": "Interface",
  "settings.interfaceFooter": "These preferences are stored locally and restored on the next launch.",
  "settings.startupInterface": "Default startup interface",
  "settings.startupInterfaceDetail": "Choose which layout Pi opens with.",
  "settings.startupInterface.default": "Default",
  "settings.startupInterface.work": "Work Mode",
  "settings.ideEnabled": "Enable IDE editor",
  "settings.ideEnabledDetail": "Turn off to skip EditorCanvas and CodeMirror and always use the Agent/Work layout.",
