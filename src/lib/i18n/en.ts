...
export const en = {
  ...
  "repository.writeDisabledRefreshing": "Wait for repository status to finish refreshing.",
  "repository.safeWriteFooter": "Only explicitly staged changes are committed. Push is never automatic.",
  ...
  "repository.error.unsafeRepositoryConfiguration": "Repository-defined Git filters are disabled for safe review and commit.",
