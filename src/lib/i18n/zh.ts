...
export const zh: Record<keyof typeof en, string> = {
  ...
  "repository.writeDisabledRefreshing": "请等待仓库状态刷新完成。",
  "repository.safeWriteFooter": "只提交明确暂存的变更，且绝不会自动推送。",
  ...
  "repository.error.unsafeRepositoryConfiguration": "为确保审查与提交安全，已禁用仓库定义的 Git 过滤器。",
