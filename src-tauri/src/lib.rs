...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            chat_store::chat_session_trash_list,
            ...
            pi_bridge::pi_generate_commit_message,
            ...
            repository::repository_phase3,
            repository::repository_phase4,
            repository::repository_phase4b,
            ...
            remote_provider_sync::remote_provider_sync_apply_automatic,
