...
export const en = {
  ...
  "settings.interfaceFooter": "Applies now and on every launch. Chat only hides the editor; the agent can still read, edit, and run anything in your project.",
  "settings.layoutMode": "Interface layout",
  "settings.layoutMode.default": "Editor",
  "settings.layoutMode.work": "Chat",
  "settings.layoutMode.work-only": "Chat only",
  "settings.layoutMode.defaultHint": "Editor, file tree, and a docked chat rail. ⌘/ switches to chat.",
  "settings.layoutMode.workHint": "Opens in the centered chat column. ⌘/ returns to the editor.",
  "settings.layoutMode.work-onlyHint": "Chat column only. The editor never loads and its entry points are hidden.",
