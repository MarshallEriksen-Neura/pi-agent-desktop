...
export const zh: Record<keyof typeof en, string> = {
  ...
  "plugins.installed": "已安装 {source} — 重启 pi 后加载。",
  "plugins.removed": "已移除 {source} — 重启 pi 后卸载。",
  ...
  "store.installUnexpected": "无法执行 pi install：{err}",
  "store.noErrorDetail": "没有诊断输出",
