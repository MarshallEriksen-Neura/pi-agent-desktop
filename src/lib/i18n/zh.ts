...
export const zh: Record<keyof typeof en, string> = {
  ...
  "browser.liveView": "浏览器实时画面",
  "browser.loading": "浏览器加载中…",
  "browser.waitingFrame": "等待第一帧画面…",
  "browser.frameStale": "正在显示上一帧画面 — 连接可能较慢。",
  "browser.allowlistTitle": "已授权站点",
  "browser.allowlistHint": "pi 无需询问即可访问这些站点。删除某个站点后,再次访问将需要授权。",
  "browser.allowlistEmpty": "还没有授权任何站点。",
  "browser.allowlistRemove": "从授权列表移除",
  "browser.idleTitle": "浏览器面板空闲",
  "browser.idleHint": "启动内置浏览器,让 pi 拥有一个实时、可控的 Chrome。访问过的站点只需授权一次,之后会被记住。",
  "browser.approveTitle": "允许 pi 打开该网站?",
