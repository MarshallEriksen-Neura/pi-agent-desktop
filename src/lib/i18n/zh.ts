...
export const zh: Record<keyof typeof en, string> = {
  ...
  "settings.category.generalDetail": "语言、启动界面、通知、更新与窗口行为。",
  "settings.interface": "界面",
  "settings.interfaceFooter": "这些偏好保存在本机，并在下次启动时自动恢复。",
  "settings.startupInterface": "默认启动界面",
  "settings.startupInterfaceDetail": "选择 Pi 启动后默认进入的布局。",
  "settings.startupInterface.default": "Default",
  "settings.startupInterface.work": "Work Mode",
  "settings.ideEnabled": "启用 IDE 编辑器",
  "settings.ideEnabledDetail": "关闭后不挂载 EditorCanvas / CodeMirror，并始终使用 Agent/Work 布局。",
