...
export const zh: Record<keyof typeof en, string> = {
  ...
  "settings.interfaceFooter": "即时生效，并在每次启动时恢复。纯对话只是不显示编辑器，Agent 仍可正常读取、修改和执行项目里的一切。",
  "settings.layoutMode": "界面布局",
  "settings.layoutMode.default": "编辑器",
  "settings.layoutMode.work": "对话",
  "settings.layoutMode.work-only": "纯对话",
  "settings.layoutMode.defaultHint": "编辑器、文件树与停靠的对话栏。⌘/ 切到对话。",
  "settings.layoutMode.workHint": "启动即进入居中的对话列。⌘/ 可切回编辑器。",
  "settings.layoutMode.work-onlyHint": "只有对话列。编辑器不会加载，相关入口一并隐藏。",
